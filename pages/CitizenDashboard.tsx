        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {reports.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {reports.map(report => (
                <div key={report.id} className={`rounded-xl shadow-sm border overflow-hidden group hover:shadow-md transition-shadow ${theme === 'dark' ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'}`}>
